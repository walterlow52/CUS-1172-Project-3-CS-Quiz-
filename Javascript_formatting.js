...
document.addEventListener('DOMContentLoaded', () => {
  quiz_application.view = module.questions[quiz_application.question_i].question;
  ...
  if (quiz_application.view == "#view_intro") {
    if (e.target.dataset.action == "start") {
     quiz_application.question_i = 0
      quiz_application.model = display(module).questions[quiz_application.question_i].question;
